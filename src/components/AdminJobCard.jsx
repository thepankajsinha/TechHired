...
function AdminJobCard({
  ...
  const { deleteJob } = useFirebase(); // Firebase context
  ...
  return (
    <div className="mx-auto mb-4 max-w-4xl">
      <div className="flex justify-between items-center px-6 py-4 mt-5 bg-zinc-200 rounded-md border border-black shadow-lg hover:border-blue-500 hover:translate-y-1 hover:scale-105 transition-transform">
        {/* Job Details */}
